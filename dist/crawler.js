...
var url = 'https://www.w3school.com.cn/';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    parser = url.split('/');
                    if (!parser[0].includes('http')) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, axios_1.default)("".concat(parser[0], "://").concat(parser[2], "/robots.txt"))
                            .then(function (resp) {
                            console.log(resp);
                        })];
                case 1:
